...
class  widgetComment extends StatefulWidget{
  ...
  @override
  State<widgetComment> createState() => widgetComment_(info: info,parent: parent);
}

class widgetComment_ extends State<widgetComment>{
  Comment? info;
  InfoView_? parent;
  widgetComment_({
    Key? key,
                ...
                children: [
                  ...
                  GestureDetector(child: Text('Répondre',style: AppStyle.txtRoboto(size: 18),maxLines: 2,overflow: TextOverflow.ellipsis,),
                    onTap: (){
                      ...
                      parent!.replyTo.replyTo = info!.id;
                      parent!.replyTo.userName = info!.userName;
                      parent!.replyTo.userId = info!.userId;
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  Spacer(),
                  Text('Afficher '+(info!.comments - replies.length).toString() + ' reponses',style: AppStyle.txtRoboto(size: 18).copyWith(
